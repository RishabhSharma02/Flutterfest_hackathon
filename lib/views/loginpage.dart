          ...
          children: [
                ...
                child: Column(
                  children: [
                    LottieBuilder.network(
                        "https://assets9.lottiefiles.com/packages/lf20_KvK0ZJBQzu.json"),
                    Padding(
            ...
            Padding(
              ...
              child: Container(
                  ...
                  child: TextButton(
                      onPressed: () {
                        Get.off(() => OtpScreen(phoneno: _controller.text),
              ...
              child: Row(
                ...
                children: [
                  Container(
                      width: 46.sp,
                      height: 46.sp,
                      child: Icon(PhosphorIcons.bold.googleLogo),
                      decoration: BoxDecoration(
                          border: Border.all(color: Color(0xFFC8C8C8)),
                          borderRadius: BorderRadius.circular(20))),
                  Container(
                      width: 46.sp,
                      height: 46.sp,
                      child: Icon(PhosphorIcons.fill.appleLogo),
                      decoration: BoxDecoration(
                          border: Border.all(color: Color(0xFFC8C8C8)),
                          borderRadius: BorderRadius.circular(20))),
                  Container(
